...
public class ShopPro implements Shop {
    ...
    @Autowired
    public ShopPro(PriceGenerator priceGenerator, CartService cartService) {
    ...
    public void showProductsFromCart(Cart cart) {
        ...
        System.out.println("Suma z podatkiem VAT(" + tax + ") i rabatem("+ discount + ")" + ": " + cartService.calculateSumWithTaxAndDiscount(cart, tax, discount));
    }
